      ...
      <div className="max-w-[var(--max-width-content)] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-[800px] mx-auto mb-12 lg:mb-16">
          ...
          <div className="relative text-center">
            <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 text-[var(--color-navy-accent)] mb-3 sm:mb-4 opacity-70 mx-auto">
              <Quote className="w-full h-full" />
            </div>
            <blockquote className="font-[var(--font-family-sans)] text-[clamp(1.063rem,2vw,1.375rem)] leading-[1.6] sm:leading-[1.7] text-[var(--color-charcoal)] m-0 p-0 font-normal">
        ...
        <div className="max-w-[800px] mx-auto mt-8 sm:mt-12 lg:mt-16">
          <p className="text-[clamp(0.938rem,2vw,1.125rem)] leading-[1.6] sm:leading-[1.7] text-[var(--color-gray)] text-center">
