            ...
            <div className="lg:col-span-2">
              ...
              <ul className="list-none p-0 my-6">
                {goals.map((goal, index) => (
                  <li
                    key={index}
                    className="pl-8 mb-4 relative text-lg leading-relaxed text-[var(--color-gray)] before:content-['•'] before:absolute before:left-0 before:text-[var(--color-navy-accent)] before:text-[1.5em]"
                  >
                    {goal}
                  </li>
                ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 my-8">
                {stats.map((stat, index) => (
                  <div
                    key={index}
                    className="bg-[var(--color-cream)] p-8 rounded-lg text-center border-2 border-[var(--color-navy-accent)]"
                  >
                    <div className="font-[var(--font-family-heading)] text-[clamp(2rem,4vw,3rem)] font-bold text-[var(--color-navy-accent)] mb-2">
                      {stat.value}
                    </div>
