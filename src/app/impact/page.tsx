...
const impactStats = [
  ...
  { value: "75%", label: "Of world's coral species present" },
      ...
      <section className="py-16 lg:py-24 bg-[var(--color-off-white)]">
        <div className="max-w-[var(--max-width-content)] mx-auto px-8">
          <div className="max-w-[900px] mx-auto">
            ...
            <p className="text-lg leading-[1.7] text-[var(--color-gray)] mb-8">
              Based on data from similar MPAs in Raja Ampat and the broader
              Coral Triangle, we project the following outcomes over the first 5
              years:
            </p>
